...
const translations: Record<Locale, TranslationKeys> = {
  en: {
    ...
    courses: { title: "Courses & Certificates", subtitle: "Continuous learning and professional development", all: "All", viewCert: "View Certificate" },
  ...
  ja: {
    ...
    courses: { title: "コース & 認定", subtitle: "継続的な学習と専門能力の開発", all: "すべて", viewCert: "証明書を見る" },
  ...
  zh: {
    ...
    courses: { title: "课程 & 证书", subtitle: "持续学习和专业发展", all: "全部", viewCert: "查看证书" },
  ...
  id: {
    ...
    courses: { title: "Kursus & Sertifikat", subtitle: "Pembelajaran berkelanjutan dan pengembangan profesional", all: "Semua", viewCert: "Lihat Sertifikat" },
  ...
  ar: {
    ...
    courses: { title: "الدورات والشهادات", subtitle: "التعلم المستمر والتطوير المهني", all: "الكل", viewCert: "عرض الشهادة" },
  ...
  ru: {
    ...
    courses: { title: "Курсы и сертификаты", subtitle: "Непрерывное обучение и профессиональное развитие", all: "Все", viewCert: "Просмотреть сертификат" },
  ...
  de: {
    ...
    courses: { title: "Kurse & Zertifikate", subtitle: "Kontinuierliches Lernen und berufliche Entwicklung", all: "Alle", viewCert: "Zertifikat anzeigen" },
  ...
  fr: {
    ...
    courses: { title: "Cours & Certificats", subtitle: "Apprentissage continu et développement professionnel", all: "Tous", viewCert: "Voir le certificat" },
